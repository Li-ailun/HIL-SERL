...
#include "teleoperation_msg_ros2/srv/detail/switch_control_mode_vr__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = teleoperation_msg_ros2::srv::SwitchControlModeVR_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const teleoperation_msg_ros2::srv::SwitchControlModeVR_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<teleoperation_msg_ros2::srv::SwitchControlModeVR_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SwitchControlModeVR_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const teleoperation_msg_ros2::srv::SwitchControlModeVR_Request *>(
...
static size_t _SwitchControlModeVR_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SwitchControlModeVR_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _SwitchControlModeVR_Request__callbacks = {
...
static rosidl_message_type_support_t _SwitchControlModeVR_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SwitchControlModeVR_Request__callbacks,
...
{
  return &teleoperation_msg_ros2::srv::typesupport_fastrtps_cpp::_SwitchControlModeVR_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = teleoperation_msg_ros2::srv::SwitchControlModeVR_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const teleoperation_msg_ros2::srv::SwitchControlModeVR_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<teleoperation_msg_ros2::srv::SwitchControlModeVR_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SwitchControlModeVR_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const teleoperation_msg_ros2::srv::SwitchControlModeVR_Response *>(
...
static size_t _SwitchControlModeVR_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SwitchControlModeVR_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _SwitchControlModeVR_Response__callbacks = {
  "teleoperation_msg_ros2::srv",
...
static rosidl_message_type_support_t _SwitchControlModeVR_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SwitchControlModeVR_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &teleoperation_msg_ros2::srv::typesupport_fastrtps_cpp::_SwitchControlModeVR_Response__handle;
}
...
static service_type_support_callbacks_t _SwitchControlModeVR__callbacks = {
  "teleoperation_msg_ros2::srv",
  "SwitchControlModeVR",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, teleoperation_msg_ros2, srv, SwitchControlModeVR_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, teleoperation_msg_ros2, srv, SwitchControlModeVR_Response)(),
...
static rosidl_service_type_support_t _SwitchControlModeVR__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SwitchControlModeVR__callbacks,
...
{
  return &teleoperation_msg_ros2::srv::typesupport_fastrtps_cpp::_SwitchControlModeVR__handle;
}
